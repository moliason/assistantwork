...
(async () => {
    ...
    try {
        ...
        await page.reload();
        await page.locator('[data-dashboard-layout="table"]').click();
        ...
        await page.locator('#dashboardNextDay').click();
        ...
        await page.locator('[data-perspective="boss"]').click();
        assert.equal(await page.locator('#itineraryRows tr').count(), 5);
        ...
        await page.locator('[data-perspective="mine"]').click();
        assert.equal(await page.locator('#itineraryRows tr').count(), 5);
        await page.locator('#itineraryRows button', {hasText: '待确认安排'}).click();
